...
def main(argv):
	...
	end_date_string = ''
	if len(argv) == 0:
		print('./goerli_img_hunt.py -s <start date> -e <end date>')
		print('./goerli_img_hunt.py --start <start date> --end <end date>')
		print('Hint: date format might be like : YYYY-MM-DD')
		sys.exit(2)
	try:
	...
	if start_date > end_date:
		print('\n[-] Start Date should be less than End Date...Swapping dates.')
	...
	print('[>] Start Date : {}'.format(start_date_string))
	print('[>] End Date   : {}\n'.format(end_date_string))
